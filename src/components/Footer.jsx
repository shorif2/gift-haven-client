const Footer = () => {
  return (
    <footer className="relative z-10 bg-gray-50 pb-10 pt-20 lg:pb-20 lg:pt-[120px] ">
          ...
          <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
            <div className="mb-10 w-full">
              ...
              <div className="mb-6 flex items-center">
                <div className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark border-primary hover:bg-primary hover:text-white sm:mr-4 lg:mr-3 xl:mr-4 dark:border-dark-3  dark:hover:border-primary">
                  <svg
                    width="8"
                    height="16"
                    viewBox="0 0 8 16"
