const LoadingButton = () => {
  return (
    <button className="inline-flex gap-4 justify-center items-center w-full text-white py-2 text-center bg-primary border border-primary rounded hover:bg-transparent hover:text-primary transition uppercase font-roboto font-medium">
      <span>
        <svg
