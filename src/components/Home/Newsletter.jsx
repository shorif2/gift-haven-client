const Newsletter = () => {
  return (
    <section className="relative z-10 bg-white py-10 lg:py-[80px] dark:bg-dark">
      <div className="container mx-auto">
        <div className="overflow-hidden rounded bg-[rgb(240,244,255)] dark:bg-dark-2">
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full self-center px-4 lg:w-1/2">
              <div className="relative z-10 px-6 py-9 sm:p-10">
                <h2 className="mb-6 text-3xl font-semibold text-dark sm:text-4xl ">
                  Subscribe Now
                </h2>
