const Pagination = () => {
  return (
    <div className="flex justify-center space-x-1 dark:text-gray-800 pt-16">
      <button
        title="previous"
        type="button"
      ...
      <button
        type="button"
        title="Page 1"
        className="inline-flex items-center justify-center w-8 h-8 text-sm font-semibold border rounded shadow-md dark:bg-gray-50 dark:text-primary dark:border-primary"
      >
        1
      </button>
      <button
